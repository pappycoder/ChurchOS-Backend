/**
 * @file update-asset.dto.ts
 * @description DTO for updating an existing asset.
 *
 * @module assets/dto
 * @since 1.0.0
 */
...
export class UpdateAssetDto {
  @ApiPropertyOptional({ description: 'Unique asset tag within the church', example: 'AUD-001' })
  @IsString()
  @IsOptional()
  @MaxLength(50)
  assetTag?: string;

  @ApiPropertyOptional({ description: 'Asset name', example: 'Yamaha Mixer' })
  @IsString()
  @IsOptional()
  @MaxLength(200)
  name?: string;
  ...
  @ApiPropertyOptional({ description: 'Depreciation method', enum: DepreciationMethod })
