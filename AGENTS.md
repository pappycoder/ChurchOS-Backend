...
- **Reports routes hardened with `@RequirePermissions` + Reports module shipped on the web** (the web `/reports` pages — Financial, Attendance, Members — shipped this round too; see web changelog):
